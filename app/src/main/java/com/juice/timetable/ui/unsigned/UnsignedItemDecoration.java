...
public class UnsignedItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private UnsignedItemDecoration(int horizonSpan, int verticalSpan, int color, boolean showLastLine) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    /*
         ...
         * */
    /*
        public UnsignedItemDecoration.Builder setShowLastLine(boolean show){
            mShowLastLine = show;
            return this;
        }

        public UnsignedItemDecoration build() {
            return new UnsignedItemDecoration(mHorizonSpan, mVerticalSpan, mColor,mShowLastLine);
        }
    }*/
}
